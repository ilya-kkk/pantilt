...
DOC_NAME = "pantilt_hc_v760_reference_v8_51107_integral_pan_gt2"
...
P = {
    ...
    "camera_d": 139.0,
    "camera_mass_kg": 0.6,
    "camera_cog_from_rear": 79.8,
    "camera_front_overhang": 40.0,
    "camera_rear_overhang": 60.0,
    "camera_left_service_clearance": 20.0,
    "camera_lcd_hinge_x": 35.0,
    "camera_plate_l": 39.0,
    "camera_plate_w": 98.0,
    "camera_plate_t": 5.0,
    "camera_plate_center_x": 10.0,
    "camera_plate_center_y": 10.0,
    "tilt_cheek_l": 60.0,
    "left_tilt_cheek_y": 57.0,
    "right_tilt_cheek_y": -37.0,
    "nema_w": 42.0,
    "nema_l": 48.0,
    "nema_bolt": 31.0,
    "nema_bolt_d": 3.5,
    ...
    "pan_thrust_bearing_od": 52.0,
    "pan_thrust_bearing_id": 35.0,
    "pan_thrust_bearing_h": 12.0,
    "pan_thrust_seat_d": 52.4,
    "pan_thrust_seat_depth": 1.0,
    "pan_radial_bearing_od": 22.0,
    "pan_radial_bearing_id": 8.0,
    "pan_radial_bearing_w": 7.0,
    "pan_608_press_interference": 0.10,
    "pan_journal_d": 7.9,
    "pan_thrust_hub_d": 34.6,
    "pan_gear_bore_d": 58.0,
    "pan_platform_od": 150.0,
    # Square top face. Edge 76 clears the pan motor body (its +x face is at
    # x=-77, which the old 160 mm plate would have hit by 3 mm) and the yoke
    # plate footprints (both x -76..52, left yoke y 66..76) sit fully on it,
    # left plate flush against the square edges.
    "pan_platform_square": 152.0,
    "pan_platform_t": 7.0,
    "belt_pitch": 2.0,
    "belt_w": 10.0,
    "belt_t": 2.0,
    ...
    "pan_motor_x": -98.0,
    "pan_belt_nominal_length": 350.0,
    "pan_motor_mount_z": 63.0,
    "pan_belt_z": 52.0,
    "tilt_axis_x": 10.3,
    "tilt_axis_z": 180.0,
    "tilt_motor_x": -35.7,
...
P["camera_cog_x"] = -P["camera_d"] / 2 + P["camera_cog_from_rear"]
P["tilt_axis_x"] = P["camera_cog_x"]
P["camera_plate_l"] = (
    P["camera_d"] - P["camera_front_overhang"] - P["camera_rear_overhang"]
)
P["camera_plate_center_x"] = (
    -P["camera_d"] / 2 + P["camera_rear_overhang"] + P["camera_plate_l"] / 2
)
P["camera_plate_w"] = 78.0 + P["camera_left_service_clearance"]
P["camera_plate_center_y"] = P["camera_left_service_clearance"] / 2
P["left_tilt_cheek_y"] = 37.0 + P["camera_left_service_clearance"]
P["right_tilt_cheek_y"] = -37.0
P["left_yoke_y"] = 51.0 + P["camera_left_service_clearance"]
P["tilt_motor_x"] = P["tilt_axis_x"] - 46.0
P["left_bearing_y"] = P["left_yoke_y"] + 4.5
P["left_bearing_cap_y"] = P["left_yoke_y"] + 9.0
P["right_bearing_y"] = P["right_yoke_y"] - 4.5
P["right_bearing_cap_y"] = P["right_bearing_y"] - 4.5
P["pan_608_pocket_d"] = P["pan_radial_bearing_od"] - P["pan_608_press_interference"]
P["pan_fixed_plate_top_z"] = 66.0
P["pan_thrust_stack_bottom_z"] = P["pan_fixed_plate_top_z"] - P["pan_thrust_seat_depth"]
P["pan_thrust_stack_top_z"] = P["pan_thrust_stack_bottom_z"] + P["pan_thrust_bearing_h"]
P["pan_platform_bottom_z"] = P["pan_thrust_stack_top_z"] - P["pan_thrust_seat_depth"]
P["pan_platform_center_z"] = P["pan_platform_bottom_z"] + P["pan_platform_t"] / 2
P["pan_radial_bearing_center_z"] = 58.0
P["pan_journal_bottom_z"] = P["pan_radial_bearing_center_z"] - P["pan_radial_bearing_w"] / 2 + 0.1
P["pan_motor_face_z"] = P["pan_fixed_plate_top_z"]

GT2_PROFILE_METRICS = {}
PAN_GT2_PROFILE_METRICS = {}
...
def gt2_2mr_pulley_z(teeth, width, center, bore=0.0, flanges=True):
    """Build the same production 2MR outline around the vertical pan axis."""
    x, y, z = center
    shape, metrics = gt2_2mr_pulley_y(teeth, width, (0, 0, 0), flanges=flanges)
    shape.rotate(vec(0, 0, 0), vec(1, 0, 0), 90)
    shape.translate(vec(x, y, z))
    if bore > 0:
        shape = shape.cut(cyl_z(bore / 2, width + 5, center))
    metrics = dict(metrics)
    metrics["axis"] = "Z"
    metrics["bore_diameter_mm"] = bore
    metrics["solid_valid"] = shape.isValid()
    return shape.removeSplitter(), metrics
...
def make_spreadsheet(doc):
    ...
    values = [
        ...
        ("CAMERA_COG_FROM_REAR", P["camera_cog_from_rear"], "mm"),
        ("CAMERA_FRONT_OVERHANG", P["camera_front_overhang"], "mm"),
        ("CAMERA_REAR_OVERHANG", P["camera_rear_overhang"], "mm"),
        ("CAMERA_LEFT_SERVICE_CLEARANCE", P["camera_left_service_clearance"], "mm"),
        ("CAMERA_LCD_HINGE_X", P["camera_lcd_hinge_x"], "mm"),
        ("CAMERA_PLATE_LENGTH", P["camera_plate_l"], "mm"),
        ("CAMERA_PLATE_WIDTH", P["camera_plate_w"], "mm"),
        ("PAN_THRUST_BEARING_OD", P["pan_thrust_bearing_od"], "mm"),
        ("PAN_THRUST_BEARING_ID", P["pan_thrust_bearing_id"], "mm"),
        ("PAN_THRUST_BEARING_HEIGHT", P["pan_thrust_bearing_h"], "mm"),
        ("PAN_THRUST_SEAT_DIAMETER", P["pan_thrust_seat_d"], "mm"),
        ("PAN_THRUST_SEAT_DEPTH", P["pan_thrust_seat_depth"], "mm"),
        ("PAN_608_POCKET_DIAMETER", P["pan_608_pocket_d"], "mm"),
        ("PAN_JOURNAL_DIAMETER", P["pan_journal_d"], "mm"),
        ("PAN_GEAR_BORE_DIAMETER", P["pan_gear_bore_d"], "mm"),
        ...
        ("PAN_BELT_NOMINAL_LENGTH", P["pan_belt_nominal_length"], "mm"),
...
def build_base(doc, base_group, objects):
    ...
    pedestal = cyl_z(27, 56, (0, 0, 38))
    motor_foot = box(90, 94, 10, (-77, 0, 5))
    motor_arm = box(60, 94, 6, (P["pan_motor_x"], 0, P["pan_motor_mount_z"]))
    left_wall = box(60, 6, 50, (P["pan_motor_x"], -44, 35))
    right_wall = box(60, 6, 50, (P["pan_motor_x"], 44, 35))
    base = (
        base.fuse(pedestal)
        .fuse(motor_foot)
        .fuse(motor_arm)
    ...
    # The 51107 housing washer locates in a shallow 52.4 mm pocket.
    base = base.cut(cyl_z(P["pan_thrust_seat_d"] / 2, 2, (0, 0, 66)))
    pocket_bottom = P["pan_radial_bearing_center_z"] - P["pan_radial_bearing_w"] / 2
    pocket_h = P["pan_fixed_plate_top_z"] - pocket_bottom + 1
    base = base.cut(
        cyl_z(
            P["pan_608_pocket_d"] / 2,
            pocket_h,
            (0, 0, pocket_bottom + pocket_h / 2),
        )
    )
    ...
    base = base.cut(
        slot_z(
            ...
            pilot_slot_width,
            8,
            (P["pan_motor_x"], 0, P["pan_motor_mount_z"]),
            along="x",
        )
    )
    ...
    objects["BASE_three_leg_frame_51107_608_motor_mount"] = add(
        doc, base_group, "BASE_three_leg_frame_51107_608_motor_mount", base, "printed"
    )
    ...
    objects["BASE_pan_motor_NEMA17"] = add(
        ...
        box(
            ...
            P["nema_w"],
            P["nema_l"],
            (P["pan_motor_x"], 0, P["pan_motor_face_z"] + P["nema_l"] / 2),
        ),
        "motor",
    )
    objects["BASE_pan_motor_pilot"] = add(
        ...
        cyl_z(
            P["nema_pilot_d"] / 2,
            P["nema_pilot_h"],
            (P["pan_motor_x"], 0, P["pan_motor_face_z"] - P["nema_pilot_h"] / 2),
        ),
        "steel",
    )
    objects["BASE_pan_motor_shaft"] = add(
        ...
        cyl_z(
            P["nema_shaft_d"] / 2,
            P["nema_shaft_l"],
            (P["pan_motor_x"], 0, P["pan_motor_face_z"] - P["nema_shaft_l"] / 2),
        ),
        "steel",
    )
    ...
    objects["BASE_pan_608_radial_bearing_press_fit"] = add(
        doc,
        base_group,
        "BASE_pan_608_radial_bearing_press_fit",
        ring_z(
            P["pan_radial_bearing_od"],
            P["pan_radial_bearing_id"],
            P["pan_radial_bearing_w"],
            (0, 0, P["pan_radial_bearing_center_z"]),
        ),
        "bearing",
    )
    objects["BASE_pan_51107_lower_housing_washer"] = add(
        doc,
        base_group,
        "BASE_pan_51107_lower_housing_washer",
        ring_z(52, 37, 3.5, (0, 0, 66.75)),
        "bearing",
    )
    cage = ring_z(47, 39, 1.2, (0, 0, 71))
    balls = [
        Part.makeSphere(3.0, vec(21.5 * math.cos(math.radians(i * 360 / 11)), 21.5 * math.sin(math.radians(i * 360 / 11)), 71))
        for i in range(11)
    ]
    objects["BASE_pan_51107_ball_cage"] = add(
        doc,
        base_group,
        "BASE_pan_51107_ball_cage",
        Part.makeCompound([cage] + balls),
        "bearing",
    )
    objects["BASE_pan_51107_upper_shaft_washer"] = add(
        doc,
        base_group,
        "BASE_pan_51107_upper_shaft_washer",
        ring_z(52, 35, 3.5, (0, 0, 75.25)),
        "bearing",
    )
...
def yoke_side_shape(side):
    ...
    if side > 0:
        ...
        plate = prism_y(base_points, wall_t, y0).fuse(
            prism_y(rear_arm_points, wall_t, y0)
        )
    else:
        points = [
            (-76, 83),
...
def build_pan_rotating(doc, pan_group, objects):
    global PAN_GT2_PROFILE_METRICS
    drive_gear, PAN_GT2_PROFILE_METRICS = gt2_2mr_pulley_z(
        P["pan_driven_teeth"],
        P["belt_w"],
        (0, 0, P["pan_belt_z"]),
        bore=P["pan_gear_bore_d"],
    )

    # Square-topped pan platform: a 152 mm square plate fully covers both pan
    # yoke footprints (left yoke y 66..76, right yoke y -66.5..-56.5, both
    # x -76..52), so the yokes sit on a flat square top face, not a disc.
    platform = box(
        P["pan_platform_square"],
        P["pan_platform_square"],
        P["pan_platform_t"],
        (0, 0, P["pan_platform_center_z"]),
    )
    upper_seat = ring_z(
        P["pan_thrust_seat_d"],
        P["pan_thrust_hub_d"] + 0.2,
        2,
        (0, 0, P["pan_platform_bottom_z"]),
    )
    platform = platform.cut(upper_seat)
    skirt = ring_z(82, P["pan_gear_bore_d"], 19.5, (0, 0, 66.55))
    thrust_hub_h = P["pan_thrust_stack_top_z"] - 65.3
    thrust_hub = cyl_z(
        P["pan_thrust_hub_d"] / 2,
        thrust_hub_h,
        (0, 0, 65.3 + thrust_hub_h / 2),
    )
    journal_h = P["pan_thrust_stack_top_z"] - P["pan_journal_bottom_z"]
    journal = cyl_z(
        P["pan_journal_d"] / 2,
        journal_h,
        (0, 0, P["pan_journal_bottom_z"] + journal_h / 2),
    )
    # One integral printed solid: square platform + both pan yokes + both
    # yoke gussets + journal + thrust hub + 120T pulley.
    one_piece_pan = (
        platform
        .fuse(skirt)
        .fuse(drive_gear)
        .fuse(thrust_hub)
        .fuse(journal)
        .fuse(yoke_side_shape(1))
        .fuse(yoke_side_shape(-1))
    )
    for side in (-1, 1):
        yc = P["left_yoke_y"] if side > 0 else P["right_yoke_y"]
        gusset_y0 = yc - 8 if side > 0 else yc
        one_piece_pan = one_piece_pan.fuse(
            prism_y([(-70, 83), (-20, 83), (-20, 112)], 8, gusset_y0)
        )
    one_piece_pan = one_piece_pan.removeSplitter()
    objects["PAN_ROTATING_one_piece_platform_journal_120T_GT2"] = add(
        doc,
        pan_group,
        "PAN_ROTATING_one_piece_platform_journal_120T_GT2",
        one_piece_pan,
        "printed",
    )

    objects["BASE_pan_GT2_350mm_belt"] = add(
        doc,
        pan_group,
        "BASE_pan_GT2_350mm_belt",
        belt_z(
            (P["pan_motor_x"], 0),
            P["pan_motor_pitch_d"],
            (0, 0),
    ...
    objects["PAN_ROTATING_left_608_bearing"] = add(
        ...
        ring_y(
            ...
            P["bearing_608_id"],
            P["bearing_608_w"],
            (P["tilt_axis_x"], P["left_bearing_y"], P["tilt_axis_z"]),
        ),
        "bearing",
    )
    objects["PAN_ROTATING_right_608_bearing"] = add(
        ...
        ring_y(
            ...
            P["bearing_608_id"],
            P["bearing_608_w"],
            (P["tilt_axis_x"], P["right_bearing_y"], P["tilt_axis_z"]),
        ),
        "bearing",
    )
    objects["PAN_ROTATING_left_bearing_cap"] = add(
        ...
        ring_y(32, 8.6, 2, (P["tilt_axis_x"], P["left_bearing_cap_y"], P["tilt_axis_z"])),
        "printed_dark",
    )
    objects["PAN_ROTATING_right_bearing_cap"] = add(
        ...
        ring_y(32, 8.6, 2, (P["tilt_axis_x"], P["right_bearing_cap_y"], P["tilt_axis_z"])),
        "printed_dark",
    )
...
def build_tilt_rotating(doc, tilt_group, objects):
    ...
    plate = box(
        ...
        P["camera_plate_w"],
        P["camera_plate_t"],
        (P["camera_plate_center_x"], P["camera_plate_center_y"], plate_z),
    )
    plate = plate.cut(
        slot_z(
            28,
            7.0,
            7,
            (P["camera_plate_center_x"], 0, plate_z),
            along="x",
        )
    )
    one_piece = plate
    for cheek_y in (P["right_tilt_cheek_y"], P["left_tilt_cheek_y"]):
        cheek_length = P["tilt_cheek_l"] if cheek_y < 0 else 32.0
        one_piece = one_piece.fuse(
            box(cheek_length, 6, 44, (P["tilt_axis_x"], cheek_y, 161))
        )
        one_piece = one_piece.fuse(
            cyl_y(13, 8, (P["tilt_axis_x"], cheek_y, P["tilt_axis_z"]))
        )

    left_trunnion = cyl_y(
        P["tilt_trunnion_d"] / 2,
        25,
        (P["tilt_axis_x"], P["left_yoke_y"] + 0.5, P["tilt_axis_z"]),
    )
    ...
    objects["CAMERA_flip_screen_clearance_open"] = add(
        doc,
        tilt_group,
        "CAMERA_flip_screen_clearance_open",
        box(
            4,
            68,
            45,
            (P["camera_lcd_hinge_x"], P["camera_w"] / 2 + 34, camera_center_z),
        ),
        "clearance",
        transparency=72,
    )
    objects["CAMERA_HDMI_cable_clearance_20mm"] = add(
        doc,
        tilt_group,
        "CAMERA_HDMI_cable_clearance_20mm",
        box(
            24,
            P["camera_left_service_clearance"],
            16,
            (
                P["camera_cog_x"],
                P["camera_w"] / 2 + P["camera_left_service_clearance"] / 2,
                camera_center_z - 10,
            ),
        ),
        "clearance",
    ...
    objects["CAMERA_nominal_COG"] = add(
        ...
        tilt_group,
        "CAMERA_nominal_COG",
        Part.makeSphere(3.2, vec(P["camera_cog_x"], 0, camera_center_z)),
        "reference",
    )
    ...
    objects["TILT_ROTATING_camera_mount_screw"] = add(
        ...
        cyl_z(3.1, 10, (P["camera_plate_center_x"], 0, 142)),
        "steel",
    )
...
def validate_geometry(doc, objects):
    pair_names = [
        ("tilt_right_yoke_vs_motor_body", "PAN_ROTATING_one_piece_platform_journal_120T_GT2", "PAN_ROTATING_tilt_motor_NEMA17"),
        ("tilt_right_yoke_vs_motor_pilot", "PAN_ROTATING_one_piece_platform_journal_120T_GT2", "PAN_ROTATING_tilt_motor_pilot"),
        ("tilt_right_yoke_vs_motor_pulley", "PAN_ROTATING_one_piece_platform_journal_120T_GT2", "PAN_ROTATING_tilt_motor_20T_pulley"),
        ("tilt_right_yoke_vs_motor_shaft", "PAN_ROTATING_one_piece_platform_journal_120T_GT2", "PAN_ROTATING_tilt_motor_shaft"),
        ("tilt_right_yoke_vs_integral_cradle", "PAN_ROTATING_one_piece_platform_journal_120T_GT2", "TILT_ROTATING_one_piece_cradle_trunnions_80T"),
        ...
        ("tilt_right_yoke_vs_belt", "PAN_ROTATING_one_piece_platform_journal_120T_GT2", "PAN_ROTATING_tilt_GT2_280mm_belt"),
        ("pan_base_vs_motor_body", "BASE_three_leg_frame_51107_608_motor_mount", "BASE_pan_motor_NEMA17"),
        ("pan_base_vs_motor_pilot", "BASE_three_leg_frame_51107_608_motor_mount", "BASE_pan_motor_pilot"),
        ("pan_base_vs_motor_shaft", "BASE_three_leg_frame_51107_608_motor_mount", "BASE_pan_motor_shaft"),
        ("pan_base_vs_motor_pulley", "BASE_three_leg_frame_51107_608_motor_mount", "BASE_pan_motor_20T_pulley"),
        ("pan_base_vs_belt", "BASE_three_leg_frame_51107_608_motor_mount", "BASE_pan_GT2_350mm_belt"),
        ("pan_base_vs_integral_pan", "BASE_three_leg_frame_51107_608_motor_mount", "PAN_ROTATING_one_piece_platform_journal_120T_GT2"),
        ("pan_motor_vs_integral_pan", "BASE_pan_motor_NEMA17", "PAN_ROTATING_one_piece_platform_journal_120T_GT2"),
        ("pan_608_vs_integral_journal", "BASE_pan_608_radial_bearing_press_fit", "PAN_ROTATING_one_piece_platform_journal_120T_GT2"),
        ("pan_51107_lower_vs_integral_pan", "BASE_pan_51107_lower_housing_washer", "PAN_ROTATING_one_piece_platform_journal_120T_GT2"),
        ("pan_51107_upper_vs_integral_pan", "BASE_pan_51107_upper_shaft_washer", "PAN_ROTATING_one_piece_platform_journal_120T_GT2"),
        ...
        ("open_lcd_vs_integral_cradle", "CAMERA_flip_screen_clearance_open", "TILT_ROTATING_one_piece_cradle_trunnions_80T"),
        ("open_lcd_vs_left_yoke", "CAMERA_flip_screen_clearance_open", "PAN_ROTATING_one_piece_platform_journal_120T_GT2"),
        ("hdmi_clearance_vs_integral_cradle", "CAMERA_HDMI_cable_clearance_20mm", "TILT_ROTATING_one_piece_cradle_trunnions_80T"),
        ("hdmi_clearance_vs_left_yoke", "CAMERA_HDMI_cable_clearance_20mm", "PAN_ROTATING_one_piece_platform_journal_120T_GT2"),
    ]
    pair_results = {}
    ...
    pan_integral_label = "PAN_ROTATING_one_piece_platform_journal_120T_GT2"
    pan_integral_feature_count = sum(obj.Label == pan_integral_label for obj in doc.Objects)
    pan_integral_solid_count = len(objects[pan_integral_label].Shape.Solids)
    ...
    camera_front_x = P["camera_d"] / 2
    camera_rear_x = -P["camera_d"] / 2
    plate_front_x = P["camera_plate_center_x"] + P["camera_plate_l"] / 2
    plate_rear_x = P["camera_plate_center_x"] - P["camera_plate_l"] / 2
    actual_front_overhang = round(camera_front_x - plate_front_x, 6)
    actual_rear_overhang = round(plate_rear_x - camera_rear_x, 6)
    cog_axis_x_error = round(P["tilt_axis_x"] - P["camera_cog_x"], 6)
    left_cheek_inner_y = P["left_tilt_cheek_y"] - 3.0
    camera_left_y = P["camera_w"] / 2
    camera_to_left_cheek_clearance = round(left_cheek_inner_y - camera_left_y, 6)
    right_cheek_inner_y = P["right_tilt_cheek_y"] + 3.0
    camera_right_y = -P["camera_w"] / 2
    camera_to_right_cheek_clearance = round(camera_right_y - right_cheek_inner_y, 6)
    pan_press_interference = round(
        P["pan_radial_bearing_od"] - P["pan_608_pocket_d"], 6
    )
    pan_journal_diametral_clearance = round(
        P["pan_radial_bearing_id"] - P["pan_journal_d"], 6
    )
    pan_thrust_seat_diametral_clearance = round(
        P["pan_thrust_seat_d"] - P["pan_thrust_bearing_od"], 6
    )
    pan_stack_height = round(
        P["pan_thrust_stack_top_z"] - P["pan_thrust_stack_bottom_z"], 6
    )
    pan_motor_front_face_gap = round(
        (P["pan_motor_face_z"] + P["nema_l"] / 2 - P["nema_l"] / 2)
        - P["pan_fixed_plate_top_z"],
        6,
    )
    pan_motor_shaft_end_z = P["pan_motor_face_z"] - P["nema_shaft_l"]
    pan_motor_shaft_points_down = pan_motor_shaft_end_z < P["pan_motor_face_z"]
    ...
    result = {
        ...
        "integral_pan_part_features": pan_integral_feature_count,
        "integral_pan_solid_count": pan_integral_solid_count,
        ...
        "camera_saddle": {
            "platform_length_mm": P["camera_plate_l"],
            "platform_width_mm": P["camera_plate_w"],
            "platform_center_x_mm": P["camera_plate_center_x"],
            "platform_center_y_mm": P["camera_plate_center_y"],
            "front_overhang_mm": actual_front_overhang,
            "rear_overhang_mm": actual_rear_overhang,
            "camera_cog_from_rear_mm": P["camera_cog_from_rear"],
            "camera_cog_x_mm": P["camera_cog_x"],
            "tilt_axis_x_mm": P["tilt_axis_x"],
            "cog_axis_x_error_mm": cog_axis_x_error,
            "camera_to_left_cheek_clearance_mm": camera_to_left_cheek_clearance,
            "camera_to_right_cheek_clearance_mm": camera_to_right_cheek_clearance,
            "left_side_added_clearance_mm": P["camera_left_service_clearance"],
            "open_lcd_envelope_present": True,
            "hdmi_20mm_envelope_present": True,
        },
        "pan_bearing_stack": {
            "thrust_bearing_model": "51107 / 8107",
            "thrust_bearing_dimensions_mm": [
                P["pan_thrust_bearing_id"],
                P["pan_thrust_bearing_od"],
                P["pan_thrust_bearing_h"],
            ],
            "thrust_stack_height_mm": pan_stack_height,
            "seat_diameter_mm": P["pan_thrust_seat_d"],
            "seat_depth_each_side_mm": P["pan_thrust_seat_depth"],
            "seat_diametral_clearance_mm": pan_thrust_seat_diametral_clearance,
            "radial_bearing_model": "608-2RS",
            "radial_bearing_dimensions_mm": [
                P["pan_radial_bearing_id"],
                P["pan_radial_bearing_od"],
                P["pan_radial_bearing_w"],
            ],
            "press_fit_pocket_diameter_mm": P["pan_608_pocket_d"],
            "press_fit_diametral_interference_mm": pan_press_interference,
            "integral_plastic_journal_diameter_mm": P["pan_journal_d"],
            "journal_to_bearing_diametral_clearance_mm": pan_journal_diametral_clearance,
        },
        "pan_direct_drive": {
            "motor_shaft_points_down": pan_motor_shaft_points_down,
            "motor_front_face_gap_mm": pan_motor_front_face_gap,
            "motor_tension_travel_mm": P["tilt_motor_tension_travel"],
            "driven_teeth": P["pan_driven_teeth"],
            "motor_teeth": P["pan_motor_teeth"],
            "belt_width_mm": P["belt_w"],
        },
        ...
        "pan_gt2_profile": PAN_GT2_PROFILE_METRICS,
        "passed": (
            len(invalid) == 0
            and all(value <= 0.01 for value in all_volumes)
            and integral_feature_count == 1
            and integral_solid_count == 1
            and pan_integral_feature_count == 1
            and pan_integral_solid_count == 1
            ...
            and abs(actual_front_overhang - P["camera_front_overhang"]) <= 0.01
            and abs(actual_rear_overhang - P["camera_rear_overhang"]) <= 0.01
            and abs(cog_axis_x_error) <= 0.01
            and camera_to_left_cheek_clearance >= P["camera_left_service_clearance"]
            and camera_to_right_cheek_clearance >= 1.0
            and abs(pan_stack_height - P["pan_thrust_bearing_h"]) <= 0.01
            and 0.2 <= pan_thrust_seat_diametral_clearance <= 0.6
            and 0.05 <= pan_press_interference <= 0.2
            and 0.05 <= pan_journal_diametral_clearance <= 0.2
            and pan_motor_shaft_points_down
            and abs(pan_motor_front_face_gap) <= 0.001
            and PAN_GT2_PROFILE_METRICS.get("profile") == "GT2/2MR modified curvilinear"
            and PAN_GT2_PROFILE_METRICS.get("teeth") == P["pan_driven_teeth"]
            and PAN_GT2_PROFILE_METRICS.get("arc_count") == P["pan_driven_teeth"] * 5
            and PAN_GT2_PROFILE_METRICS.get("land_segment_count") == P["pan_driven_teeth"]
            and PAN_GT2_PROFILE_METRICS.get("wire_closed")
            and PAN_GT2_PROFILE_METRICS.get("face_valid")
            and PAN_GT2_PROFILE_METRICS.get("solid_valid")
...
def write_docs(validation):
    ...
    saddle = validation["camera_saddle"]
    bom = f"""# BOM V8

## Printed concept parts
- 1x three-leg lower base with integral 51107/608 seats and downward-shaft pan motor mount
- 1x one-piece pan rotating solid: {P['pan_platform_square']:.0f} mm square-topped platform with both pan yokes (LCD-clearance rear-routed left support, direct-NEMA17 right support), both gussets, plastic journal, thrust hub, connector skirt, and real 120T GT2/2MR pulley — one printed part
- 2x 608 bearing caps
- 1x one-piece printed tilt cradle with a {P['camera_plate_l']:.0f}x{P['camera_plate_w']:.0f} mm camera saddle, both cheeks, two 7.9 mm trunnions, and integral inboard 80T GT2/2MR pulley with a 10 mm face

## Bought components
- 1x NEMA17 stepper motor for pan
- 1x StepperOnline 17HS19-2004S1 NEMA17 for tilt, 42x42x48 mm with a 5x24 mm shaft
- 1x 51107 / 8107 thrust bearing, 35x52x12 mm
- 3x 608-2RS bearing, 8x22x7 mm: two tilt and one pan radial bearing
- 1x GT2 20T metal pulley for pan; the 120T driven pulley is integral to the printed pan platform
- 1x GT2 20T metal pulley for tilt; the 80T driven pulley is integral to the printed cradle
- 1x GT2 10 mm belt, approximately {P['pan_belt_nominal_length']:.0f} mm for pan; confirm after setting motor position
...
- The square ({P['pan_platform_square']:.0f} mm) topped pan platform, both pan yokes, both gussets, journal, thrust hub, connector skirt, and real 120T GT2/2MR pulley form one printed solid.
...
- Camera saddle is {saddle['platform_length_mm']:.1f}x{saddle['platform_width_mm']:.1f} mm, leaving {saddle['front_overhang_mm']:.1f} mm front and {saddle['rear_overhang_mm']:.1f} mm rear overhang.
- Tilt axis X={saddle['tilt_axis_x_mm']:.1f} mm follows the stated camera COG at {saddle['camera_cog_from_rear_mm']:.1f} mm from the rear.
- Camera-left clearance to the rotating cheek is {saddle['camera_to_left_cheek_clearance_mm']:.1f} mm; the left fixed support is routed behind the LCD sweep.

## Drive
- Pan pitch diameter: {P['pan_driven_pitch_d']:.2f} mm, ratio {pan_ratio:.1f}:1.
- Pan profile topology: {validation['pan_gt2_profile']['arc_count']} arcs, {validation['pan_gt2_profile']['land_segment_count']} land segments, closed={validation['pan_gt2_profile']['wire_closed']}.
- Pan compensated outside diameter: {validation['pan_gt2_profile']['compensated_outside_diameter_mm']:.4f} mm with a {P['belt_w']:.1f} mm face.
...
- Integral pan Part::Feature count: {validation['integral_pan_part_features']}
- Integral pan solid count: {validation['integral_pan_solid_count']}
- 51107 seat clearance: {validation['pan_bearing_stack']['seat_diametral_clearance_mm']:.2f} mm diametral
- Pan 608 pocket interference: {validation['pan_bearing_stack']['press_fit_diametral_interference_mm']:.2f} mm diametral
- Plastic journal-to-608 clearance: {validation['pan_bearing_stack']['journal_to_bearing_diametral_clearance_mm']:.2f} mm diametral
- Pan motor shaft points down: {validation['pan_direct_drive']['motor_shaft_points_down']}
...
- Verify the modeled LCD hinge X={P['camera_lcd_hinge_x']:.1f} mm and the HDMI plug envelope against the physical camera before final printing.
...
def build():
    ...
    assembly.Label = "PAN_TILT_REFERENCE_V8_51107_INTEGRAL_PAN_GT2"
    ...
    pan_one_piece_step_path = os.path.join(
        OUT_DIR, "pan_one_piece_square_platform_yokes_120T_GT2.step"
    )
    pan_one_piece_stl_path = os.path.join(
        OUT_DIR, "pan_one_piece_square_platform_yokes_120T_GT2.stl"
    )
    base_step_path = os.path.join(OUT_DIR, "base_51107_608_downshaft_nema17.step")
    base_stl_path = os.path.join(OUT_DIR, "base_51107_608_downshaft_nema17.stl")
    ...
    try:
        ...
        Import.export(
            [objects["PAN_ROTATING_one_piece_platform_journal_120T_GT2"]],
            pan_one_piece_step_path,
        )
        Import.export(
            [objects["BASE_three_leg_frame_51107_608_motor_mount"]],
            base_step_path,
        )
        import Mesh
    ...
    if os.path.exists(pan_one_piece_step_path):
        print("WROTE", pan_one_piece_step_path)
    if os.path.exists(pan_one_piece_stl_path):
        print("WROTE", pan_one_piece_stl_path)
    for path in (
        base_step_path,
        base_stl_path,
    ):

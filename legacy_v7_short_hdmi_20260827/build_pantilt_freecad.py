...
DOC_NAME = "pantilt_hc_v760_reference_v7_short_hdmi_clearance_cradle"
...
def build_pan_rotating(doc, pan_group, objects):
    ...
    objects["PAN_ROTATING_platform_with_cable_bore"] = add(
        ...
        ring_z(P["pan_platform_od"], P["pan_cable_bore"], 6, (0, 0, 80)),
        "printed",
    )
...
def validate_geometry(doc, objects):
    pair_names = [
        ...
        ("open_lcd_vs_left_yoke", "CAMERA_flip_screen_clearance_open", "PAN_ROTATING_left_yoke"),
        ("hdmi_clearance_vs_integral_cradle", "CAMERA_HDMI_cable_clearance_20mm", "TILT_ROTATING_one_piece_cradle_trunnions_80T"),
        ("hdmi_clearance_vs_left_yoke", "CAMERA_HDMI_cable_clearance_20mm", "PAN_ROTATING_left_yoke"),
    ]
    pair_results = {}
...
- 1x {P['pan_platform_od']:.0f} mm rotating pan platform with {P['pan_cable_bore']:.0f} mm cable bore
- 1x asymmetric two-sided yoke: LCD-clearance left support and direct-NEMA17 right support
- 2x 608 bearing caps
...
def build():
    ...
    assembly.Label = "PAN_TILT_REFERENCE_V7_SHORT_HDMI_CLEARANCE_CRADLE"
    ...
    left_yoke_step_path = os.path.join(OUT_DIR, "left_pan_yoke_lcd_clearance.step")
    left_yoke_stl_path = os.path.join(OUT_DIR, "left_pan_yoke_lcd_clearance.stl")
    pan_platform_step_path = os.path.join(OUT_DIR, "pan_platform_wide_150mm.step")
    pan_platform_stl_path = os.path.join(OUT_DIR, "pan_platform_wide_150mm.stl")
    ...
    try:
        ...
        Import.export([objects["PAN_ROTATING_left_yoke"]], left_yoke_step_path)
        Import.export(
            [objects["PAN_ROTATING_platform_with_cable_bore"]],
            pan_platform_step_path,
        )
        import Mesh
        ...
        Mesh.export([objects["PAN_ROTATING_left_yoke"]], left_yoke_stl_path)
        Mesh.export(
            [objects["PAN_ROTATING_platform_with_cable_bore"]],
            pan_platform_stl_path,
        )

...
- Compact two-sided yoke with the right bearing support moved outward for the inboard tilt pulley
...
- cad_checks.md
- BOM.md
- screenshots/01_isometric_v6.png through screenshots/10_pan45_tilt18_v6.png
- screenshots/11_reference_comparison_v6.png
- screenshots/12_gt2_2mr_profile_closeup_v6.png
- screenshots/13_direct_tilt_motor_mount_v6.png
- screenshots/14_integrated_nema17_tension_slots_v6.png
...
- do not treat the pan 120T ring as production-ready: its teeth remain a conceptual visual representation in v6;
...
The previous separate-motor-mount v5 is preserved under `legacy_v5_printable_gt2_20260827/`. Earlier revisions remain under their corresponding legacy directories.

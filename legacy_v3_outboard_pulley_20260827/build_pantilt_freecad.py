...
DOC_NAME = "pantilt_hc_v760_reference_v3_integral_tilt"
...
def build_tilt_rotating(doc, tilt_group, objects):
    ...
    right_trunnion = cyl_y(
        P["tilt_trunnion_d"] / 2,
        34.2,
        (P["tilt_axis_x"], -56.1, P["tilt_axis_z"]),
    )
...
- 2x 608 bearing caps
- 1x one-piece printed tilt cradle with camera plate, both cheeks, two 7.9 mm trunnions, and integral 80T pulley
...
def build():
    ...
    assembly.Label = "PAN_TILT_REFERENCE_V3_INTEGRAL_TILT"

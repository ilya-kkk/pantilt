...
- Extended tilt motor shaft passes through a dedicated clearance hole in the right yoke
...
- cad_checks.md
- BOM.md
- screenshots/01_isometric_v5.png through screenshots/10_pan45_tilt18_v5.png
- screenshots/11_reference_comparison_v5.png
- screenshots/12_gt2_2mr_profile_closeup_v5.png
...
- do not treat the pan 120T ring as production-ready: its teeth remain a conceptual visual representation in v5;
...
The previous visual-tooth v4 is preserved under `legacy_v4_visual_gt2_20260827/`. Earlier revisions remain under their corresponding legacy directories.

...
def make_reference_comparison():
    ...
    command = [
        ...
        "-y",
        "-i",
        os.path.join(SCREEN_DIR, "01_isometric_v5.png"),
        "-i",
        os.path.join(SCREEN_DIR, "07_tilt_drive_focus_v5.png"),
        "-i",
        os.path.join(SCREEN_DIR, "02_front_v5.png"),
    ]
    ...
    command.extend(
        [
            ...
            "-update",
            "1",
            os.path.join(SCREEN_DIR, "11_reference_comparison_v5.png"),
        ]
    )
...
save_view("01_isometric_v5.png", view.viewIsometric)
print("SCREENSHOT_STAGE", "saved_01")

set_pose()
save_view("02_front_v5.png", view.viewFront)
print("SCREENSHOT_STAGE", "saved_02")
save_view("03_side_v5.png", view.viewRight)
print("SCREENSHOT_STAGE", "saved_03")
save_view("04_top_v5.png", view.viewTop)
print("SCREENSHOT_STAGE", "saved_04")

make_exploded()
save_view("05_exploded_v5.png", view.viewIsometric)
print("SCREENSHOT_STAGE", "saved_05")

set_pose()
save_view("06_pan_drive_focus_v5.png", view.viewTop, mode="pan_focus")
print("SCREENSHOT_STAGE", "saved_06")
save_view("07_tilt_drive_focus_v5.png", view.viewIsometric, mode="tilt_focus", show_axes=True)
print("SCREENSHOT_STAGE", "saved_07")

set_pose(pan_angle=-18, tilt_angle=60)
save_view("08_tilt_plus60_v5.png", view.viewIsometric, show_axes=True)

set_pose(pan_angle=-18, tilt_angle=-60)
save_view("09_tilt_minus60_v5.png", view.viewIsometric, show_axes=True)

set_pose(pan_angle=45, tilt_angle=18)
save_view("10_pan45_tilt18_v5.png", view.viewIsometric)
...
time.sleep(0.2)
view.saveImage(
    os.path.join(SCREEN_DIR, "12_gt2_2mr_profile_closeup_v5.png"),
    1600,
    1200,
    "White",
)
